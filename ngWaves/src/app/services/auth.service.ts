...
export class AuthService {
    ...
    return this.http
      ...
      .pipe(
        ...
        catchError((err: any) => {
          console.log(err);
          return throwError(
            'AuthService.getUserByUsername(): Error getting user in.'
          );
        })
      );
  }
  ...
  reverse(user: User): Observable<User> {
    ...
    return this.http
      .put<User>(
        this.baseUrl + `api/auth/update/${user.id}`,
        user,
        this.getHttpOptions()
      )
      .pipe(
  ...
  reverseBeach(beach: Beach): Observable<Beach> {
    ...
    return this.http
      .put<Beach>(
        this.baseUrl + `api/auth/beaches/${beach.id}`,
        beach,
        this.getHttpOptions()
      )
      .pipe(
  ...
  createBeach(beach: Beach): Observable<Beach> {
    ...
    return this.http
      .post<Beach>(
        this.baseUrl + 'api/auth/beaches/location',
        beach,
        this.getHttpOptions()
      )
      .pipe(
  ...
  getFavorites(): Observable<Beach[]> {
    return this.http
      .get<Beach[]>(this.baseUrl + 'api/auth/favorites', this.getHttpOptions())
      .pipe(
        catchError((err: any) => {
          console.log(err);
  ...
  addFavorites(beach: Beach): Observable<Beach> {
    return this.http
      .post<Beach>(
        this.baseUrl + 'api/auth/favorites' + '/' + beach.id,{},
        this.getHttpOptions()
      )
      .pipe(
        catchError((err: any) => {
          console.log(err);
          return throwError('Error adding to favorites');
        })
      );
  }
  destroyFavorites(beachId: number) {
    return this.http
      .delete(
        this.baseUrl + 'api/auth/favorites' +'/'+ beachId,
        this.getHttpOptions()
      )
      .pipe(
        catchError((err: any) => {
          console.log(err);
          return throwError('Error deleting favorite');
        })
      );
  }
